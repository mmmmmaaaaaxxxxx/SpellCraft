...
execute positioned ~-.5 ~ ~-1.5 run function noi:altar/wands/compile_att {path:1}
execute positioned ~-.5 ~ ~-2.5 run function noi:altar/wands/compile_att {path:2}
execute positioned ~-.5 ~ ~-3.5 run function noi:altar/wands/compile_att {path:3}
execute positioned ~-.5 ~ ~-4.5 run function noi:altar/wands/compile_att {path:4}
execute positioned ~-.5 ~ ~-5.5 run function noi:altar/wands/compile_att {path:5}
execute positioned ~-.5 ~ ~-6.5 run function noi:altar/wands/compile_att {path:6}
